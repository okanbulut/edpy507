...
#install.packages("mirt", repos = "https://cloud.r-project.org", dependencies=TRUE)
#library("mirt")
...
The EFA analyses demonstrated above can also be easily done using a **Shiny** application that I created. This application allows users to import their data into R, visualize the correlation matrix of observed variables, and perform EFA using the **psych** package. This **Shiny** app can be initiated using the following codes:

```{r irt188, echo=TRUE, eval=FALSE}
shiny::runGitHub("EFA", "okanbulut")
```

For those of you who want to use this **Shiny** app, here is a short video demonstrating how to import your data and perform EFA:

<iframe src="https://capture.dropbox.com/embed/UooFfdoTHCV7a7m4?source=copy-embed" width="750" height="450" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
