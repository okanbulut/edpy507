...
Now, let's import the [hci.csv](/data_and_codes/hci.csv) dataset into R and review the first six rows using the `head()` function:
...
```{r ctt42, echo=FALSE, R.options = list(width = 100)}
