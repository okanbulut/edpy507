...
```{r ctt15b, R.options = list(width = 200)}
...
reliability_qme <- QME::analyze(test = response_experiment, id = FALSE, na_to_0 = FALSE)
...
```{r dif2, echo=FALSE, R.options = list(width = 110)}
hci_scored <- read.csv(paste0(getwd(), "/data_and_codes/hci_scored.csv"), header = TRUE)
